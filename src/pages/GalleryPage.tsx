...
const photos = [
  ...
  { src: galleryPineapple, alt: "Fresh Pineapple Shake", caption: "Pineapple Shake — ₹10" },
  { src: galleryMango, alt: "Fresh Mango Shake", caption: "Mango Shake — ₹10" },
  { src: galleryApple, alt: "Fresh Apple Shake", caption: "Apple Shake — ₹10" },
  { src: galleryGuava, alt: "Fresh Guava Shake", caption: "Guava Shake — ₹10" },
  { src: galleryKharbuja, alt: "Fresh Kharbuja Juice", caption: "Kharbuja Juice — ₹50" },
  { src: galleryOrange, alt: "Fresh Orange Juice", caption: "Orange Juice — ₹50" },
  { src: galleryPineappleJuice, alt: "Fresh Pineapple Juice", caption: "Pineapple Juice — ₹50" },
  { src: galleryFalooda, alt: "Ice Cream Falooda", caption: "Ice Cream Falooda — ₹30" },
  { src: galleryLassi, alt: "Ice Cream Lassi", caption: "Ice Cream Lassi — ₹30" },
];


const instagramReels = [
  { title: "Fresh Juice Making", reelId: "DVmkM40jLBH" },
];
