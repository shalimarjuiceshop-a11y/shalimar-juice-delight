...
const content = {
  hinglish: {
    ...
    supportPoints: [
      "Company will run your shop for first 12 months.",
      "Company will teach you everything.",
      "After 12 months, you can run the shop yourself.",
      "Company support available anytime.",
    ],
  ...
  hindi: {
    ...
    supportPoints: [
      "पहले 12 महीने कंपनी आपकी शॉप चलाएगी।",
      "कंपनी आपको सब कुछ सिखाएगी।",
      "12 महीने के बाद आप खुद शॉप चला सकते हैं।",
      "कंपनी का सपोर्ट कभी भी मिलेगा।",
    ],
