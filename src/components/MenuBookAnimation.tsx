 ...
 * Designed to sit beside the "Our Menu" heading on both mobile and desktop.
 * Subtle warm cream + gold palette to match the brand.
 */
const PAGES = [
  {
    title: "JUICES",
      ...
      >
        <defs>
          <linearGradient id="mb_cover" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="100%" stopColor="hsl(0 80% 24%)" />
          </linearGradient>
