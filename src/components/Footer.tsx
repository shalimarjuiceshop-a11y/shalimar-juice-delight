      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 rounded-lg bg-primary text-foreground font-body font-semibold text-[11px] shadow-md hover:shadow-lg hover:scale-105 transition-all"
          >
