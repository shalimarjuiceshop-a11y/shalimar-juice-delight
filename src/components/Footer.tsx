      ...
      <div className="grid md:grid-cols-3 gap-10">
        ...
        <div>
          <div className="flex items-center gap-2.5 mb-4">
            <img src={sjsLogo} alt="SJS Logo" className="w-12 h-12 rounded-full object-cover border-2 border-border shadow-sm" />
            <div>
              <h3 className="font-display text-base font-bold text-foreground">Shalimar Juice</h3>
              <p className="text-[10px] text-muted-foreground/60" dir="rtl" style={{ fontFamily: "'Noto Nastaliq Urdu', serif" }}>شالیمار جوس</p>
            </div>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-muted text-foreground font-body font-medium text-xs hover:bg-muted/80 transition-colors"
          >
        ...
        {/* Shop Info */}
        <div>
          <h4 className="font-display text-sm font-bold uppercase tracking-wider mb-4 text-foreground">Shop Info</h4>
        ...
        {/* Location */}
        <div>
          <h4 className="font-display text-sm font-bold uppercase tracking-wider mb-4 text-foreground">Location</h4>
          <iframe
